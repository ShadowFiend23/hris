...
class UpdateEmployeeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            // Employee ID - unique within company except current record
            'employee_id' => [
                'nullable',
                'string',
                'max:50',
            ...
            'date_resigned' => ['nullable', 'date', 'after:date_hired'],
            'department_id' => [
                'sometimes',
                'required',
                'integer',
    ...
    public function messages(): array
    {
        return [
            ...
            'date_resigned.after' => 'The resignation date must be after the hire date.',
    ...
    public function attributes(): array
    {
        return [
            ...
            'date_resigned' => 'resignation date',
