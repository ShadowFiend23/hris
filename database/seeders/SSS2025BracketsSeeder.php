...
/**
 * SSS Circular No. 2024-006 — Schedule of Contributions effective January 2025.
 * Stores total employee contribution (Regular SS + MPF) as employee_amount.
 * Stores total employer contribution (Regular SS + MPF + EC) as employer_amount.
 */
class SSS2025BracketsSeeder extends Seeder
{
    public function run(): void
    {
        ContributionBracket::where('type', 'sss')->where('is_active', true)->update(['is_active' => false]);

        $note = 'SSS Circular No. 2024-006, effective January 2025';
        $date = '2025-01-01';

        // [min_salary, max_salary, employee_amount, employer_amount]
